        ...
        while response is None:
                try:
                        ...
                        if 'id' in response:
                                ...
                                vid = response['id']
                                code =  hashlib.md5(vid+"??????").hexdigest()
                                print(code)
                                h = httplib2.Http(".cache")
                                (resp_headers, content) = h.request("http://mri.ee.ntust.edu.tw/proj/youtube_add.php?vid="+vid+"&code="+code,"GET")
                        else:
...
if __name__ == '__main__':
        ...
        parser.add_option("--title", dest="title", help="Video title",
                default=yesterday.strftime("%m%d"))
